...
@dataclass
class PlotConfig:
    """Settings shared by fitting and summary plots."""
...
def sized_fig(ncols, nrows,
              ...
              gap_w=0.6, gap_h=1.1):
    """Create equal-sized subplot axes and return their positions."""
    if cell_h is None:
...
def _deconv_color_by_count(j, i, S, N, cfg=None, cmap_name='PRGn'):
    """Color one specific/nonspecific composition cell from configured maps."""
...
def plot_species_curves(L_grid_M, F_grid, num_species, cfg, *, output_svg=None,
                        ...
                        legend_kd_unit=None):
    """Plot model fractions with optional observations and error bars."""
